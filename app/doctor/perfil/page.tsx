      ...
      <div className="h-full bg-secondary p-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-7">
          ...
          <div className="md:col-span-1">
            <Card className="text-center">
              <CardHeader className="flex flex-col items-center">
                ...
                <CardTitle>Dr. Carlos Rodríguez</CardTitle>
            ...
            <Card className="mt-6">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span>carlos.rodriguez@clinica.com</span>
                </div>
                <div className="flex items-center">
                  <Phone size={18} className="mr-2 text-gray-500" />
                  <span>+54 11 5555-5678</span>
                </div>
                <div className="flex items-center">
          ...
          <div className="md:col-span-2">
                ...
                <form className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input type="text" id="nombre" value="Carlos" disabled />
                    </div>
                    <div>
                      <label
                        className="text-sm text-gray-500 block mb-1"
            ...
            <Card className="mt-6">
              <CardHeader>
                <CardTitle className="text-lg">Horario de consulta</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
